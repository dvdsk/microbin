...
mkdir -p $install_dir
cd $install_dir
$download_command https://raw.githubusercontent.com/dvdsk/microbin/master/.env
$download_command https://raw.githubusercontent.com/dvdsk/microbin/master/compose.yaml
